...
<a class="btn btn-secondary" href="logout.php" style="float: right;">Logout</a>
<br /><br />
...
<?php
    ...
    while ($row = $result->fetch_object()) {
        ...
        echo '<td>
                  ...
                  <a class="btn btn-danger btn-sm" href="delete_customer.php?id='. $row->customerid.'" onclick="return confirm(\'Are you sure you want to delete this customer?\')">Delete</a>
              </td>';
        echo '</tr>';
        $i++;  
    }
